...
namespace Capstone
{
    internal class PageCart
    {
        ...
        public static void Logout(IWebDriver driver)
        {
            ...
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("/html/body/div[4]/div[1]/div[1]/div[2]/div[1]/ul/li[2]/a")).Click();                     // Select on the Logout link in the page header.  

            string loginString = driver.FindElement(By.XPath("/html/body/div[4]/div[1]/div[1]/div[2]/div[1]/ul/li[2]/a")).Text;   // Home page with login option is displayed
